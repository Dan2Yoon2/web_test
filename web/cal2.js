$(document).ready(function() {
     ...
     * Open datepicker2
     */
    $('.redesign-datepicker2-group input').on('focus', function (e) {
        $('.datepicker2').addClass('open');
    })

    $('.redesign-datepicker2-group input').on('blur', function (e) {
        e.preventDefault();
    })
    ...
    $('.datepicker2 .btn-ok').on('click tap', function () {

        //which field is the datepicker2 for
        var dateFor = $(this).closest('.datepicker2').attr('data-for');

        //select the field to be populated
        var dateInput = $('.redesign-datepicker2-group[data-for="' + dateFor + '"]').find('input');
        //blur the input
        dateInput.blur();
        ...
        //close datepicker2
        $(this).closest('.datepicker2').removeClass('open');
    ...
    $('.btn-select-year').on('click tap', function () {
        ...
        $('.datepicker2 .section').removeClass('active');

        //add active class to the year slider section
        $('.datepicker2 .section.year-slider').addClass('active');
    })
    ...
    $('.btn-date-label').on('click tap', function () {
        ...
        //add active class to the year slider section
        $('.datepicker2 .section.calendar').addClass('active');
    })
...
//Calendar initializer
    ...
    function populateYearSlider(thisYear) {
        ...
        var years = $('.datepicker2 .year-slider .years');
